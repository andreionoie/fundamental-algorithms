/*	NOTE:
		...
		------------------------------------------------------------------
		|0.80|      2.54|           5.63|          26.25|          40.20|
		------------------------------------------------------------------
		|0.85|      2.82|           7.78|          33.38|          54.83|
		------------------------------------------------------------------
		|0.90|      3.21|          11.91|          47.05|          81.85|
		------------------------------------------------------------------
		|0.95|      3.91|          23.75|          78.41|         159.71|
		------------------------------------------------------------------
		|0.99|      5.43|         101.86|         229.71|         755.83|
		------------------------------------------------------------------
...
unsigned int getRandom(int max) {
	double d = drand48();  // gives you a number from 0 to 1
	double val = d * max;	  // gives you a number from 0 to max
